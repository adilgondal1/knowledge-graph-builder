    ...
    'relationships': {
      ...
      items: {
        ...
        properties: {
          'source': {
            type: Type.STRING,
            description: 'Entity1 Name. Names should be formatted "First Last" with a space in the middle. If there is a comma in the name, assume the first string is the last name and the second is the first name and format appropriately.',
          },
          'sourceType': {
            type: Type.STRING,
          ...
          'relationship': {
            type: Type.STRING,
            description: 'Relationship type (works_for/located_in/attended/etc).Make sure multiples words are connected with an underscore.',
          },
          'target': {
            type: Type.STRING,
            description: 'Entity2 Name. Names should be formatted "First Last" with a space in the middle. If there is a comma in the name, assume the first string is the last name and the second is the first name and format appropriately.',
          },
          'targetType': {
            type: Type.STRING,
